...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SocialApp_Sites', fields ['site', 'socialapp']
        db.create_unique(u'socialaccount_socialapp_sites', ['site_id', 'socialapp_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SocialApp_Sites', fields ['site', 'socialapp']
        db.delete_unique(u'socialaccount_socialapp_sites', ['site_id', 'socialapp_id'])
    ...
    models = {
        ...
        u'socialaccount.socialapp': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['sites.Site']", 'symmetrical': 'False', 'through': u"orm['socialaccount.SocialApp_Sites']", 'blank': 'True'})
        },
        u'socialaccount.socialapp_sites': {
            'Meta': {'unique_together': "(('site', 'socialapp'),)", 'object_name': 'SocialApp_Sites'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'socialapp': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['socialaccount.SocialApp']"})
        },
