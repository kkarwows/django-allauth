...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialApp.enabled'
        db.add_column(u'socialaccount_socialapp', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocialApp.enabled'
        db.delete_column(u'socialaccount_socialapp', 'enabled')
